      ...
      nodes = {
        ...
        [0x000A] = {
          ...
          nodes = {
            ...
            [0x0065] = {
              name = "Status Zugsicherung",
              attributes = {
                [0x0001] = { typ = "string", name = "Bauart Zugsicherungssystem", },
              ...
              nodes = {
                ...
                [0x0003] = {
                  ...
                  attributes = {
                    [0x0002] = { typ = "word", name = "Zustand Zugsicherung", enum = {
                      [1] = "ausgeschaltet",
                      [2] = "abgeschaltet/gestört (1000 Hz blinkt)",
                      [3] = "Hauptluftleitung unter 2,2 bar (1000 Hz blinkt)",
                    ...
                    [0x0029] = { typ = "byte", name = "Melder Zugart Links", enum = aus_an, },
                    [0x002A] = { typ = "byte", name = "Melder Zugart 65", enum = aus_an, },
                    [0x002B] = { typ = "byte", name = "Melder Zugart Rechts", enum = aus_an, },
                  },
                },
              },
            },
            [0x0066] = {
              ...
              attributes = {
                ...
                [0x000A] = { typ = "byte", name = "Melder „Zwangsschließen“", enum = aus_an, },
                [0x000B] = { typ = "byte", name = "Melder „Zwangsschließen möglich“", enum = {
                  [0] = "Aus",
                  [1] = "Dauerlicht",
                  [2] = "Blinkend",
                }},
                [0x000C] = { typ = "byte", name = "Melder „Türen links+rechts“", enum = aus_an, },
                [0x000D] = { typ = "byte", name = "Melder „Türen links+rechts“", enum = {
                  [0] = "Aus",
                  [1] = "Dauerlicht",
                  [2] = "Blinkend",
                }},
